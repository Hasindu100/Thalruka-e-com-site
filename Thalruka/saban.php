	...
	<div class="container">
		...
		<div class="col-md-6 phone-w3l">
			<ul>
				...
				<li style="color:red;float:right"><a href="logout.php">logout</li>
		...
		<div class="sap_tabs">			
			<div id="horizontalTab">
				<ul class="resp-tabs-list">
					<?php
					$out='<a href="saban.php?username='.$username.'&cat_id=1"><li class="resp-tab-item"><span>සිල්ලර බඩු</span></li></a>
					<a href="saban.php?username='.$username.'&cat_id=2"><li class="resp-tab-item"><span>සබන් වර්ග</span></li></a>
				...
				<div class="resp-tabs-container">
					...
					<?php
						...
						$cat_id=$_GET['cat_id'];
						//echo $username;
						$query = $db->query("SELECT * FROM item where cat_id=$cat_id");
