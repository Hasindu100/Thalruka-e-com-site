	...
	<div class="container">
			...
			<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav ">
						...
						$output1='<li><a href="index.php?username='.$username.'" class="hyper "><span>Home</span></a></li>	
		...
		<div class="col-md-4 search-agileinfo">
			...
			<div class="cart">
				<?php
				$username=$_GET['username'];
				$out='<form action="cart.php?username='.$username.'" method="post" class="last">';
				echo $out;
				?>
...
<?php
	...
	$sql = "SELECT item_id,name,file_name,price FROM item WHERE item_id='$item_id'";
...
$output='<div class="products">	 
			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								...
								<li data-thumb="'.$imageURL.'">
									 <div class="thumb-image"> <img src="'.$imageURL.'" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="'.$imageURL.'">
								   <div class="thumb-image"> <img src="'.$imageURL.'" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li> 
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name">'.$row["name"].'</h3>
						...
						<p>SelectQuantity
						<form action="cart.php?item_id='.$row["item_id"].'&username='.$username.'" method="post">
						<select name="qty">
							<option>1</option>
							<option>2</option>
							<option>3</option>
		...
		//<a href="cart.php?item_id='.$row["item_id"].'&username='.$username.'&qty='.$qty.'"><button type="submit" class="w3ls-cart" ><i class="fa fa-cart-plus" aria-hidden="true"></i> Add to cart</button></a>
		?>
		<hr/>		
